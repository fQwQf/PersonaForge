...
from experiments.common.harness import PersonaForgeGenerator
from experiments.common.judge import PairwiseJudge
...
请生成回复："""
    ...
    def generate_ablation(self, role_data: Dict, scenario: EvaluationScenario, ablation_type: str) -> tuple:
        ...
        from personaforge.personality_model import PersonalityProfile
